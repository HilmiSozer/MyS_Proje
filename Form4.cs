...
namespace MyS_Proje
{
    public partial class Form4 : Form
    {
        ...
        {
            e.Graphics.DrawString(this.label1.Text,this.label1.Font,Brushes.Black,0,0);
            e.Graphics.DrawString(this.label2.Text, this.label2.Font, Brushes.Black, 50, 0);
            e.Graphics.DrawString(this.label3.Text, this.label3.Font, Brushes.Black, 0, 50);
            e.Graphics.DrawString(this.label4.Text, this.label4.Font, Brushes.Black, 50, 50);
            e.Graphics.DrawString(this.label5.Text,this.label5.Font, Brushes.Black,0,150);
            e.Graphics.DrawString("TL",new Font("Ariel",12,FontStyle.Regular),Brushes.Black,50,75);
            e.Graphics.DrawImage(this.pictureBox1.Image,50,150);
        }
